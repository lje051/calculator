...
class NumberBtnView: UIView {
  ...
  var totalStackViewConstraints: AnchoredConstraints?
  ...
  func setupLayout() {
   ...
   eqaulView.addSubview(equaltoBtn)
    addSubview(eqaulView)
     totalStackViewConstraints = totalStackView.anchor(top: topAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: nil)
  //  print(totalStackViewConstraints)
...
multipleView.anchor(top:topAnchor, leading: totalStackView.trailingAnchor, bottom: thirdStackView.bottomAnchor, trailing: trailingAnchor, padding:.init(top: 0, left: 5, bottom: 0, right: 0))
  ...
  //equalView.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier:0.2).isActive = true

//    addSubview(informationLabel)
//    informationLabel.anchor(top: nil, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: 0, left: 25, bottom: 16, right: 16))
...
//    informationLabel.numberOfLines = 0
  ...
  func setupLandscapeMode(){
   ...
   func makingNumberBtn() {
    ...
    multipleBtn.backgroundColor = UIColor.orange
...
totalStackView.addArrangedSubview(firstStackView)
  totalStackView.addArrangedSubview(secondStackView)
   ...
   // totalStackViewConstraints
    //let totalStackViewConstraints = [totalStackViewConstraints.top, totalStackViewConstraints.leading]
    //  = totalStackViewConstraints as! [NSLayoutConstraint]
   // totalStackViewConstraints?.width?.isActive = false
    setupLandscapeMode()
